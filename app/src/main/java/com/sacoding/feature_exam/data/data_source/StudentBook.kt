...
object StudentBook {
    val presentSimpleLessens = listOf(
        Lessen(
            ...
            subjects = Pronouns.subjectSingularPronouns.plus(Pronouns.subjectPluralPronouns).plus(Pronouns.subjectNames),
        ...
        Lessen(
            ...
            level = Level.BEGINNER,
            tenses = listOf(Tens.PRESENT_SIMPLE),
            subjects = Pronouns.subjectSingularPronouns,
            verbs = Verbs.feelings,
            objectVals = Pronouns.subjectNames,
        ),
        Lessen(
            name = "What is your job?",
            level = Level.BEGINNER,
            tenses = listOf(Tens.PRESENT_SIMPLE),
            subjects = Pronouns.subjectSingularPronouns.plus(Pronouns.subjectNames),
            verbs = listOf(Verbs.toBe),
